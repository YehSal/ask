...
class CourseContainer extends Component {
  ...
  renderCourse() {
    ...
    if (course)
      return <Course course={course} renderPassword={this.renderPassword} />;
...
})(connect(mapStateToProps, { findCourse, submitQuestion, fetchQuestions, castUpVote, castDownVote })(CourseContainer))
